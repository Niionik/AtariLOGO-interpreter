...
onload:
    ...
    //od tej linijki w górę^ nie wiem co jest do czego bo to patrycja robiła
    //~Jakyubi
    ...
    wspx = (c.width / 2);
    wspy = (c.height / 2); //tu sie ustawia początkową pozycje od której zaczyna sie rysować i powinno chyba być tam gdzie żółw tylko nie do końca jest celnie ustawione
